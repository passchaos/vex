...
- Vex SVG output can optionally embed a machine-readable SVG metadata object index with layout/canvas facts, object geometry, waypoints, and layer metadata via `--svg-metadata`, `vex_svg_metadata=true`, or `SvgOptions.metadata`.
