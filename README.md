...
entire non-HTML parse corpus. Its fast tier contains 707 valid XML SVG results
under a two-second per-fixture gate; 15 known large/pathological fixtures form
