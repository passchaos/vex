...
entire non-HTML parse corpus. Its fast tier contains 705 valid XML SVG results
under a two-second per-fixture gate; 17 known large/pathological fixtures form
