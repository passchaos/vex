...
entire non-HTML parse corpus. Its fast tier contains 706 valid XML SVG results
under a two-second per-fixture gate; 16 known large/pathological fixtures form
