...
| SVG canvas 与对象分组 | 已验证 | size、numeric/fill/expand ratio、dpi、rotate、center、outputorder、id、class 测试；`ratio=compress` 在 layered layout 阶段处理而非 SVG 缩放 | XML 安全与 Graphviz-style group 结构持续通过 |
