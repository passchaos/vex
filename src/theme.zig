    ...
    pub fn tokens(self: Theme) Tokens {
        return switch (self) {
            ...
            .dark => .{
                ...
                .node_stroke = "#3e444c",
                .node_font = "#d2d7df",
                .node_highlight_fill = "#8f6d4d",
                .node_highlight_font = "#f1f6fb",
                .edge_stroke = "#59616c",
                .edge_font = "#d2d7df",
                .edge_label_fill = "#1e2229",
                .edge_label_stroke = "#3e444c",
                .edge_highlight_label_fill = "#2b2928",
            ...
            .print => .{
                ...
                .node_stroke = "#64748b",
                .node_font = "#111827",
                .node_highlight_fill = "#fef3c7",
                .node_highlight_stroke = "#d97706",
                .node_highlight_font = "#78350f",
                .edge_stroke = "#64748b",
                .edge_font = "#374151",
                .edge_label_fill = "#ffffff",
                .edge_label_stroke = "#cbd5e1",
                .edge_highlight_stroke = "#d97706",
                .edge_highlight_font = "#92400e",
                .edge_highlight_label_fill = "#fff7ed",
                .edge_highlight_label_stroke = "#d97706",
...
pub const Tokens = struct {
    ...
    node_highlight_fill: []const u8 = "#f0bb8c",
    node_highlight_stroke: []const u8 = "#eaa15f",
    node_highlight_font: []const u8 = "#202328",
    node_highlight_pen_width: f64 = 1.0,
    ...
    edge_highlight_stroke: []const u8 = "#eaa15f",
    edge_highlight_font: []const u8 = "#eaa15f",
    edge_highlight_pen_width: f64 = 1.1,
    edge_highlight_label_fill: []const u8 = "#fcf6f0",
    edge_highlight_label_stroke: []const u8 = "#eaa15f",
