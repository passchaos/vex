...
test "user cluster example stays compact and Graphviz-like" {
    ...
    try std.testing.expect(distanceBetween(svgScreenPoint(svg, adjacent_points.start), svgScreenPoint(graphviz_oracle, oracle_adjacent_points.start)) <= 2.0);
    try std.testing.expect(distanceBetween(svgScreenPoint(svg, adjacent_points.end), svgScreenPoint(graphviz_oracle, oracle_adjacent_points.end)) <= 2.0);
    ...
    try std.testing.expect(distanceBetween(adjacent_control1, oracle_adjacent_control1) <= 2.1);
    try std.testing.expect(distanceBetween(adjacent_control2, oracle_adjacent_control2) <= 2.0);
    ...
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "a1-&gt;a2", 2.1);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "a2-&gt;a3", 2.1);
    ...
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "a0-&gt;a1", 2.1);
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "a1-&gt;a2", 2.1);
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "a2-&gt;a3", 2.1);
