...
fn graphvizMsquareHeadInlineArrowRoute(route: EdgeRoute, rankdir: RankDir, hints: EdgePathHints) EdgeRoute {
    ...
    if (@abs(dx) < @abs(dy) * 0.35) return route;
    var result = route;
    result.end.x += if (dx >= 0) -0.45 else -0.30;
...
test "user cluster example stays compact and Graphviz-like" {
    ...
    try std.testing.expect(@abs(svgNodeScreenCenterY(svg, "a3").? - svgNodeScreenCenterY(graphviz_oracle, "a3").?) <= 0.2);
    try std.testing.expect(@abs(svgNodeScreenCenterY(svg, "b0").? - svgNodeScreenCenterY(graphviz_oracle, "b0").?) <= 0.2);
    ...
    try std.testing.expect(@abs(((svgNumberAfter(a0_fragment, " y=\"") orelse return error.MissingNodeCenter) + svgGraphvizTranslate(svg).y) - ((svgNumberAfter(oracle_a0_fragment, " y=\"") orelse return error.MissingNodeCenter) + svgGraphvizTranslate(graphviz_oracle).y)) <= 0.2);
    try std.testing.expect(@abs(((svgNumberAfter(b0_fragment, " y=\"") orelse return error.MissingNodeCenter) + svgGraphvizTranslate(svg).y) - ((svgNumberAfter(oracle_b0_fragment, " y=\"") orelse return error.MissingNodeCenter) + svgGraphvizTranslate(graphviz_oracle).y)) <= 0.2);
    ...
    try std.testing.expect(distanceBetween(cross_start, oracle_cross_start) <= 3.5);
    ...
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "b2-&gt;a3", 0.065);
    ...
    try std.testing.expect(distanceBetween(svgScreenPoint(svg, adjacent_points.end), svgScreenPoint(graphviz_oracle, oracle_adjacent_points.end)) <= 1.6);
    ...
    try std.testing.expect(distanceBetween(adjacent_control1, oracle_adjacent_control1) <= 1.8);
    try std.testing.expect(distanceBetween(adjacent_control2, oracle_adjacent_control2) <= 1.6);
    ...
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a3-&gt;a0", 0.055);
    ...
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "start-&gt;a0", 0.075);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "start-&gt;b0", 0.08);
    ...
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "b0-&gt;b1", 0.065);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "b1-&gt;b2", 0.06);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "b2-&gt;b3", 0.065);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "a1-&gt;b3", 0.065);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "a3-&gt;end", 0.065);
    try expectSvgEdgePathPointsNear(svg, graphviz_oracle, "b3-&gt;end", 0.08);
    ...
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a0-&gt;a1", 0.025);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a1-&gt;a2", 0.025);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a2-&gt;a3", 0.025);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a1-&gt;b3", 0.055);
    ...
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "b0-&gt;b1", 0.04);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "b1-&gt;b2", 0.055);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "b2-&gt;b3", 0.075);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "b2-&gt;a3", 0.04);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "a3-&gt;end", 0.075);
    try expectSvgEdgeArrowPointsNear(svg, graphviz_oracle, "b3-&gt;end", 0.09);
