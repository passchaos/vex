...
pub fn layoutLayered(allocator: std.mem.Allocator, graph: *const Graph, options: LayoutOptions) !Layout {
    ...
    shiftRightClusterMembersLeftByRankForCrossClusterTb(graph, axes, nodes, ranks, 1.35);
...
test "user cluster example stays compact and Graphviz-like" {
    ...
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "a0").? - svgNodeScreenCenterX(graphviz_oracle, "a0").?) <= 3.2);
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "a1").? - svgNodeScreenCenterX(graphviz_oracle, "a1").?) <= 3.2);
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "a2").? - svgNodeScreenCenterX(graphviz_oracle, "a2").?) <= 3.2);
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "a3").? - svgNodeScreenCenterX(graphviz_oracle, "a3").?) <= 3.2);
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "b0").? - svgNodeScreenCenterX(graphviz_oracle, "b0").?) <= 3.2);
    try std.testing.expect(@abs(svgNodeScreenCenterX(svg, "b1").? - svgNodeScreenCenterX(graphviz_oracle, "b1").?) <= 2.6);
    ...
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "a1-&gt;b3", 3.1);
    ...
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "start-&gt;a0", 2.9);
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "start-&gt;b0", 2.95);
    try expectSvgEdgeArrowTipNear(svg, graphviz_oracle, "b0-&gt;b1", 2.7);
